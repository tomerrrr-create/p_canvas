...
{
  originalName: "שחור לבן",
  emoji: '⚪⚫',
  colors: ["#ffffff","#fefefe","#fdfdfd","#fcfcfc","#fbfbfb","#fafafa","#f9f9f9","#f8f8f8","#f7f7f7","#f6f6f6","#f5f5f5","#f4f4f4","#f3f3f3","#f2f2f2","#f1f1f1","#f0f0f0","#efefef","#efefef","#eeeeee","#ededed","#ececec","#ebebeb","#eaeaea","#e9e9e9","#e8e8e8","#e7e7e7","#e6e6e6","#e5e5e5","#e4e4e4","#e3e3e3","#e2e2e2","#e1e1e1","#e0e0e0","#dfdfdf","#dedede","#dddddd","#dcdcdc","#dbdbdb","#dadada","#d9d9d9","#d8d8d8","#d7d7d7","#d6d6d6","#d5d5d5","#d4d4d4","#d3d3d3","#d2d2d2","#d1d1d1","#d0d0d0","#cfcfcf","#cfcfcf","#cecece","#cdcdcd","#cccccc","#cbcbcb","#cacaca","#c9c9c9","#c8c8c8","#c7c7c7","#c6c6c6","#c5c5c5","#c4c4c4","#c3c3c3","#c2c2c2","#c1c1c1","#c0c0c0","#bfbfbf","#bebebe","#bdbdbd","#bcbcbc","#bbbbbb","#bababa","#b9b9b9","#b8b8b8","#b7b7b7","#b6b6b6","#b5b5b5","#b4b4b4","#b3b3b3","#b2b2b2","#b1b1b1","#b0b0b0","#afafaf","#afafaf","#aeaeae","#adadad","#acacac","#ababab","#aaaaaa","#a9a9a9","#a8a8a8","#a7a7a7","#a6a6a6","#a5a5a5","#a4a4a4","#a3a3a3","#a2a2a2","#a1a1a1","#a0a0a0","#9f9f9f","#9e9e9e","#9d9d9d","#9c9c9c","#9b9b9b","#9a9a9a","#999999","#989898","#979797","#969696","#959595","#949494","#939393","#929292","#919191","#909090","#8f8f8f","#8f8f8f","#8e8e8e","#8d8d8d","#8c8c8c","#8b8b8b","#8a8a8a","#898989","#888888","#878787","#868686","#858585","#848484","#838383","#828282","#818181","#808080","#7f7f7f","#7e7e7e","#7d7d7d","#7c7c7c","#7b7b7b","#7a7a7a","#797979","#787878","#777777","#767676","#757575","#747474","#737373","#727272","#717171","#707070","#707070","#6f6f6f","#6e6e6e","#6d6d6d","#6c6c6c","#6b6b6b","#6a6a6a","#696969","#686868","#676767","#666666","#656565","#646464","#636363","#626262","#616161","#606060","#5f5f5f","#5e5e5e","#5d5d5d","#5c5c5c","#5b5b5b","#5a5a5a","#595959","#585858","#575757","#565656","#555555","#545454","#535353","#525252","#515151","#505050","#505050","#4f4f4f","#4e4e4e","#4d4d4d","#4c4c4c","#4b4b4b","#4a4a4a","#494949","#484848","#474747","#464646","#454545","#444444","#434343","#424242","#414141","#404040","#3f3f3f","#3e3e3e","#3d3d3d","#3c3c3c","#3b3b3b","#3a3a3a","#393939","#383838","#373737","#363636","#353535","#343434","#333333","#323232","#313131","#303030","#303030","#2f2f2f","#2e2e2e","#2d2d2d","#2c2c2c","#2b2b2b","#2a2a2a","#292929","#282828","#272727","#262626","#252525","#242424","#232323","#222222","#212121","#202020","#1f1f1f","#1e1e1e","#1d1d1d","#1c1c1c","#1b1b1b","#1a1a1a","#191919","#181818","#171717","#161616","#151515","#141414","#131313","#121212","#111111","#101010","#101010","#0f0f0f","#0e0e0e","#0d0d0d","#0c0c0c","#0b0b0b","#0a0a0a","#090909","#080808","#070707","#060606","#050505","#040404","#030303","#020202","#010101","#000000"]
},{
  originalName: "זהב חצות",
  emoji: '🪙🌑',
  colors: [
    "#000000", "#020100", "#040200", "#060300", "#080400", "#0a0500", "#0c0600", "#0e0700",
    "#100800", "#120900", "#140a00", "#160b00", "#180c00", "#1a0d00", "#1c0e00", "#1e0f00",
    "#201000", "#221100", "#241200", "#261300", "#281400", "#2a1500", "#2c1600", "#2e1700",
    "#301800", "#321900", "#341a00", "#361b00", "#381c00", "#3a1d00", "#3c1e00", "#3e1f00",
    "#402000", "#422100", "#442200", "#462300", "#482400", "#4a2500", "#4c2600", "#4e2700",
    "#502800", "#522900", "#542a00", "#562b00", "#582c00", "#5a2d00", "#5c2e00", "#5e2f00",
    "#603000", "#623100", "#643200", "#663300", "#683400", "#6a3500", "#6c3600", "#6e3700",
    "#703800", "#723900", "#743a00", "#763b00", "#783c00", "#7a3d00", "#7c3e00", "#7e3f00",
    "#804000", "#824100", "#844200", "#864300", "#884400", "#8a4500", "#8c4600", "#8e4700",
    "#904800", "#924900", "#944a00", "#964b00", "#984c00", "#9a4d00", "#9c4e00", "#9e4f00",
    "#a05000", "#a25100", "#a45200", "#a65300", "#a85400", "#aa5500", "#ac5600", "#ae5700",
    "#b05800", "#b25900", "#b45a00", "#b65b00", "#b85c00", "#ba5d00", "#bc5e00", "#be5f00",
    "#c06000", "#c26100", "#c46200", "#c66300", "#c86400", "#ca6500", "#cc6600", "#ce6700",
    "#d06800", "#d26900", "#d46a00", "#d66b00", "#d86c00", "#da6d00", "#dc6e00", "#de6f00",
    "#e07000", "#e27100", "#e47200", "#e67300", "#e87400", "#ea7500", "#ec7600", "#ee7700",
    "#f07800", "#f27900", "#f47a00", "#f67b00", "#f87c00", "#fa7d00", "#fc7e00", "#fe7f00",
    "#ff8000", "#ff8210", "#ff8420", "#ff8630", "#ff8840", "#ff8a50", "#ff8c60", "#ff8e70",
    "#ff9080", "#ff9290", "#ff94a0", "#ff96b0", "#ff98c0", "#ff9ad0", "#ff9ce0", "#ff9ef0",
    "#ffa000", "#ffa20a", "#ffa414", "#ffa61e", "#ffa828", "#ffaa32", "#ffac3c", "#ffae46",
    "#ffb050", "#ffb25a", "#ffb464", "#ffb66e", "#ffb878", "#ffba82", "#ffbc8c", "#ffbe96",
    "#ffc0a0", "#ffc2aa", "#ffc4b4", "#ffc6be", "#ffc8c8", "#ffcad2", "#ffccdc", "#ffcee6",
    "#ffd0f0", "#ffd2fa", "#ffd4ff", "#ffd6ff", "#ffd8ff", "#ffdaff", "#ffdcff", "#ffdeff",
    "#ffe0ff", "#ffe2ff", "#ffe4ff", "#ffe6ff", "#ffe8ff", "#ffebff", "#ffedff", "#ffefff",
    "#fff1ff", "#fff3ff", "#fff5ff", "#fff7ff", "#fff9ff", "#fffbff", "#fffdff", "#ffffff",
...
{
  originalName: "Deep Resonance",
  emoji: '🌲',
  colors: [
    "#000000", "#020105", "#04010a", "#05020f", "#070314", "#09041a", "#0a051f", "#0c0524", 
    "#0e0629", "#0f072e", "#110833", "#130938", "#150a3d", "#170a42", "#190b47", "#1b0c4c", 
    "#1d0d52", "#200e57", "#220f5c", "#241061", "#271166", "#29116b", "#2c1270", "#2e1375", 
    "#31137a", "#34147e", "#371583", "#3a1588", "#3d168d", "#401691", "#441796", "#47179a", 
    "#4a189f", "#4d18a3", "#5119a7", "#5519ab", "#581ab0", "#5c1ab4", "#601bb8", "#641bbb", 
    "#681cbf", "#6c1cc3", "#701cc6", "#741dca", "#781dcd", "#7c1dd0", "#801ed3", "#851ed6", 
    "#891fd9", "#8d1fdb", "#921fde", "#9620e0", "#9b20e2", "#a020e5", "#a421e7", "#a921e9", 
    "#ad21eb", "#b221ed", "#b721ee", "#bc21f0", "#c121f1", "#c621f3", "#cb21f4", "#d021f5", 
    "#d521f6", "#db21f7", "#e021f8", "#e521f8", "#eb21f9", "#f021f9", "#f521fa", "#fb21fa", 
    "#ff21f8", "#ff21f2", "#ff21ec", "#ff21e5", "#ff22df", "#ff22d9", "#ff22d2", "#ff22cc", 
    "#ff22c5", "#ff23bf", "#ff23b8", "#ff23b2", "#ff24ab", "#ff24a4", "#ff259d", "#ff2597", 
    "#ff2690", "#ff2789", "#ff2782", "#ff287b", "#ff2974", "#ff2a6e", "#ff2b67", "#ff2d60", 
    "#ff2e59", "#ff2f52", "#ff314b", "#ff3344", "#ff353e", "#ff3737", "#ff3930", "#ff3c2a", 
    "#ff3f23", "#ff421d", "#ff4516", "#ff4910", "#ff4c0a", "#ff5105", "#ff5500", "#fa5900", 
    "#f55e00", "#ef6300", "#ea6800", "#e46d00", "#de7200", "#d87800", "#d27e00", "#cb8300", 
    "#c58900", "#be8f00", "#b79500", "#b09c00", "#a9a200", "#a1a900", "#9aaf00", "#92b600", 
    "#8abd00", "#82c400", "#79cb00", "#70d300", "#67da00", "#5de200", "#52ea00", "#47f100", 
    "#3af900", "#30ff00", "#2df500", "#2bea00", "#28e000", "#26d500", "#24cb00", "#22c100", 
    "#20b600", "#1eac00", "#1ca100", "#1a9700", "#188d00", "#168200", "#157800", "#136e00", 
    "#116300", "#105900", "#0e4f00", "#0d4500", "#0b3b00", "#0a3100", "#082700", "#071e00", 
    "#061e05", "#051f0b", "#051f10", "#052015", "#05201a", "#05211e", "#042223", "#042227", 
    "#04232b", "#04242f", "#042433", "#042537", "#03253b", "#03263e", "#032742", "#032745", 
    "#032848", "#03284b", "#03294e", "#032951", "#022a54", "#022a56", "#022b59", "#022b5b", 
    "#022c5e", "#022c60", "#022d62", "#022d64", "#022e66", "#022e68", "#022e6a", "#022f6c", 
    "#012f6e", "#01306f", "#013071", "#013172", "#013174", "#013175", "#013276", "#013277", 
    "#013278", "#013379", "#01337a", "#01337b", "#01347c", "#01347d", "#01347d", "#01347e", 
    "#01357f", "#01357f", "#013580", "#013580", "#003681", "#003681", "#003681", "#003682", 
    "#003682", "#003682", "#003682", "#003682", "#003683", "#003683", "#003683", "#003683", 
    "#003683", "#023a86", "#053e89", "#07418c", "#09458f", "#0b4992", "#0e4d96", "#105099", 
    "#12549c", "#15589f", "#175ca2", "#195fa5", "#1b63a8", "#1e67ab", "#206bae", "#226fb1", 
    "#2572b4", "#2776b7", "#297aba", "#2c7ebd", "#2e81c0", "#3085c3", "#3289c6", "#358dc9", 
    "#3791cc", "#3994cf", "#3c98d2", "#3e9cd5", "#40a0d8", "#43a3db", "#45a7de", "#47abe1", 
    "#4aaee4", "#4cb2e7", "#4fb6ea", "#51b9ed", "#53bdf0", "#56c1f3", "#58c5f6", "#5ac8f9"
  ]
},

{
  originalName: "Quantum Spectrum",
  emoji: '🌀',
  colors: [
    "#000000", "#010005", "#02000a", "#030010", "#040015", "#05001a", "#060020", "#070025", 
    "#08002b", "#090030", "#0a0035", "#0b003a", "#0c0040", "#0d0045", "#0e004a", "#0f0050", 
    "#110055", "#12005a", "#13005f", "#140064", "#150069", "#16006e", "#180074", "#190079", 
    "#1a007e", "#1b0083", "#1d0088", "#1e008d", "#1f0092", "#210098", "#22009d", "#2300a2", 
    "#2500a7", "#2600ac", "#2800b1", "#2900b6", "#2b00bc", "#2c00c1", "#2e00c6", "#2f00cb", 
    "#3100d0", "#3200d5", "#3400da", "#3600df", "#3700e5", "#3900ea", "#3b00ef", "#3d00f4", 
    "#3e00f9", "#4000ff", "#4300ff", "#4500ff", "#4800ff", "#4a00ff", "#4d00ff", "#5000ff", 
    "#5200ff", "#5500ff", "#5800ff", "#5a00ff", "#5d00ff", "#6000ff", "#6300ff", "#6500ff", 
    "#6800ff", "#6b00ff", "#6e00ff", "#7100ff", "#7300ff", "#7600ff", "#7900ff", "#7c00ff", 
    "#7f00ff", "#8200ff", "#8500ff", "#8800ff", "#8b00ff", "#8e00ff", "#9100ff", "#9400ff", 
    "#9700ff", "#9a00ff", "#9d00ff", "#a000ff", "#a300ff", "#a600ff", "#a900ff", "#ad00ff", 
    "#b000ff", "#b300ff", "#b600ff", "#b900ff", "#bd00ff", "#c000ff", "#c300ff", "#c700ff", 
    "#ca00ff", "#cd00ff", "#d100ff", "#d400ff", "#d800ff", "#db00ff", "#df00ff", "#e200ff", 
    "#e600ff", "#ea00ff", "#ed00ff", "#f100ff", "#f500ff", "#f900ff", "#fc00ff", "#ff00fa", 
    "#ff00f5", "#ff00f1", "#ff00ec", "#ff00e7", "#ff00e2", "#ff00dd", "#ff00d8", "#ff00d4", 
    "#ff00cf", "#ff00ca", "#ff00c5", "#ff00c0", "#ff00bb", "#ff00b6", "#ff00b1", "#ff00ac", 
    "#ff00a7", "#ff00a2", "#ff009d", "#ff0098", "#ff0093", "#ff008e", "#ff0089", "#ff0084", 
    "#ff007f", "#ff057a", "#ff0a75", "#ff0f70", "#ff146b", "#ff1966", "#ff1f61", "#ff245c", 
    "#ff2957", "#ff2e52", "#ff334d", "#ff3848", "#ff3d43", "#ff423e", "#ff4739", "#ff4c34", 
    "#ff522f", "#ff572a", "#ff5c25", "#ff6120", "#ff661b", "#ff6b16", "#ff7011", "#ff750c", 
    "#ff7a07", "#ff8002", "#ff8500", "#ff8a00", "#ff8f00", "#ff9400", "#ff9900", "#ff9e00", 
    "#ffa300", "#ffa800", "#ffad00", "#ffb200", "#ffb700", "#ffbc00", "#ffc100", "#ffc600", 
    "#ffcb00", "#ffd000", "#ffd500", "#ffda00", "#ffdf00", "#ffe400", "#ffe900", "#ffee00", 
    "#fff300", "#fff800", "#fffd00", "#faff00", "#f5ff00", "#f0ff00", "#ebff00", "#e6ff00", 
    "#e1ff00", "#dcff00", "#d7ff00", "#d2ff00", "#cdff00", "#c8ff00", "#c3ff00", "#beff00", 
    "#b9ff00", "#b4ff00", "#afff00", "#aaff00", "#a5ff00", "#a0ff00", "#9bff00", "#96ff00", 
    "#91ff00", "#8cff00", "#87ff00", "#82ff00", "#7dff00", "#78ff00", "#73ff00", "#6eff00", 
    "#69ff00", "#64ff00", "#5fff00", "#5aff00", "#55ff00", "#50ff00", "#4bff00", "#46ff00", 
    "#41ff00", "#3cff00", "#37ff00", "#32ff00", "#2dff00", "#28ff00", "#23ff00", "#1eff00", 
    "#19ff00", "#14ff00", "#0fff00", "#0aff00", "#05ff00", "#00ff00", "#00ff0a", "#00ff14", 
    "#00ff1e", "#00ff28", "#00ff32", "#00ff3c", "#00ff46", "#00ff50", "#00ff5a", "#00ff64", 
    "#00ff6e", "#00ff78", "#00ff82", "#00ff8c", "#00ff96", "#00ffa0", "#00ffaa", "#00ffb4", 
    "#00ffbe", "#00ffc8", "#00ffd2", "#00ffdc", "#00ffe6", "#00fff0", "#00fffa", "#00faff", 
    "#0cf5ff", "#18f0ff", "#24ebff", "#30e6ff", "#3ce1ff", "#48dcff", "#54d7ff", "#60d2ff", 
    "#6ccdff", "#78c8ff", "#84c3ff", "#90beff", "#9cb9ff", "#a8b4ff", "#b4afff", "#c0aaff"
  ]
}
