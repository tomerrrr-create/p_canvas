...
{
    originalName: "Cosmos 264",
    emoji: '🌌',
    colors: [
        "#000000", "#040405", "#07080B", "#0B0C10", "#0A0B18", "#0A0A20", "#090A29", "#080931",
        "#070839", "#070741", "#060649", "#050652", "#04055A", "#040462", "#03036A", "#020272",
        "#01027B", "#010183", "#00008B", "#020384", "#05067D", "#070977", "#0A0C70", "#0C0F69",
        "#0E1262", "#11165C", "#131955", "#151C4E", "#181F47", "#1A2241", "#1D253A", "#1F2833",
        "#1E263B", "#1E2442", "#1D224A", "#1C2052", "#1B1F59", "#1A1D61", "#1A1B68", "#191970",
        "#1B1C69", "#1C1F62", "#1E225B", "#202654", "#21294D", "#232C46", "#242F3F", "#263238",
        "#292E3E", "#2C2A44", "#2F264A", "#322151", "#351D57", "#38195D", "#3C1563", "#3F1169",
        "#420C70", "#450876", "#48047C", "#4B0082", "#49067D", "#470D79", "#461374", "#441A6F",
        "#42206B", "#402766", "#3E2D62", "#3C345D", "#3B3A58", "#394154", "#37474F", "#394656",
        "#3B445E", "#3D4366", "#40426D", "#424174", "#44407C", "#463E84", "#483D8B", "#4D3C91",
        "#513A97", "#56399E", "#5B38A4", "#6037AA", "#6435B0", "#6934B6", "#6E33BD", "#7231C3",
        "#7730C9", "#7C2FCF", "#812ED6", "#852CDC", "#8A2BE2", "#9030E0", "#9636DE", "#9C3BDC",
        "#A240DA", "#A845D9", "#AE4AD7", "#B450D5", "#BA55D3", "#B45AD4", "#AD5ED6", "#A662D7",
        "#A067D8", "#9A6CDA", "#9370DB", "#8C72DD", "#8474E0", "#7D76E2", "#7678E4", "#6E7AE6",
        "#677CE8", "#607EEB", "#5880ED", "#5182EF", "#4A84F2", "#4386F4", "#3B88F6", "#348AF8",
        "#2D8CFA", "#258EFD", "#1E90FF", "#258CFF", "#2C87FF", "#3283FF", "#397FFF", "#407AFF",
        "#4776FF", "#4E71FF", "#556DFF", "#5B69FF", "#6264FF", "#6960FF", "#705CFF", "#7757FF",
        "#7D53FF", "#844FFF", "#8B4AFF", "#9246FF", "#9941FF", "#A03DFF", "#A639FF", "#AD34FF",
        "#B430FF", "#BB2CFF", "#C227FF", "#C823FF", "#CF1FFF", "#D61AFF", "#DD16FF", "#E411FF",
        "#EB0DFF", "#F109FF", "#F804FF", "#FF00FF", "#FD07FC", "#FA0EFA", "#F815F7", "#F61CF5",
        "#F323F2", "#F12AF0", "#EF31ED", "#EC38EA", "#EA3FE8", "#E846E5", "#E64DE3", "#E354E0",
        "#E15BDE", "#DF62DB", "#DC69D9", "#DA70D6", "#DF6FD1", "#E56ECC", "#EA6DC7", "#EF6CC3",
        "#F46BBE", "#FA6AB9", "#FF69B4", "#F86CB6", "#F06EB8", "#E871BB", "#E173BD", "#DA76BF",
        "#D278C1", "#CA7BC3", "#C37DC6", "#BC80C8", "#B482CA", "#AC85CC", "#A587CE", "#9E8AD1",
        "#968CD3", "#8E8FD5", "#8791D7", "#8094DA", "#7897DC", "#7099DE", "#699CE0", "#629EE2",
        "#5AA1E5", "#52A3E7", "#4BA6E9", "#44A8EB", "#3CABED", "#34ADF0", "#2DB0F2", "#26B2F4",
        "#1EB5F6", "#16B7F8", "#0FBAFB", "#08BCFD", "#00BFFF", "#06C2FB", "#0CC5F6", "#11C8F2",
        "#17CBEE", "#1DCEEA", "#23D1E5", "#29D4E1", "#2FD7DD", "#34DAD9", "#3ADDD4", "#40E0D0",
        "#48E0D2", "#50E0D3", "#58E0D5", "#60E0D6", "#68E0D8", "#70E0D9", "#78E0DB", "#80E0DD",
        "#88E0DE", "#90E0E0", "#98E0E1", "#A0E0E3", "#A8E0E4", "#B0E0E6", "#B7E2E4", "#BEE5E1",
        "#C6E7DF", "#CDE9DD", "#D4ECDB", "#DBEED8", "#E2F1D6", "#E9F3D4", "#F1F5D2", "#F8F8CF",
        "#FFFACD", "#FEFAD4", "#FDF9DB", "#FCF9E2", "#FBF9EA", "#FAF9F1", "#F9F8F8", "#F8F8FF",
        "#F2FAFF", "#ECFCFF", "#E6FDFF", "#E0FFFF", "#E8FFFF", "#F0FFFF", "#F7FFFF", "#FFFFFF"
    ]
    },
...
{ 
    originalName: "Cosmos 64", 
    emoji: '🌌', 
    colors: [
        "#000000", "#0B0C10", "#070839", "#040462", "#00008B", "#0A0D6E", "#151B50", "#1F2833", 
        "#1C2052", "#191970", "#202654", "#263238", "#322151", "#3F1169", "#4B0082", "#441871", 
        "#3E2F60", "#37474F", "#40426D", "#483D8B", "#5E37A8", "#7431C5", "#8A2BE2", "#A240DA", 
        "#BA55D3", "#A662D7", "#9370DB", "#7678E4", "#5880ED", "#3B88F6", "#1E90FF", "#3E7BFF", 
        "#5E67FF", "#7E52FF", "#9F3EFF", "#BF29FF", "#DF15FF", "#FF00FF", "#F61CF5", "#EC38EA", 
        "#E354E0", "#DA70D6", "#EC6CC5", "#FF69B4", "#DB75BF", "#B682C9", "#928ED4", "#6D9ADF", 
        "#49A6EA", "#24B3F4", "#00BFFF", "#15CAEF", "#2BD5E0", "#40E0D0", "#65E0D7", "#8BE0DF", 
        "#B0E0E6", "#CAE9DE", "#E5F1D5", "#FFFACD", "#FCF9E6", "#F8F8FF", "#E0FFFF", "#FFFFFF"
    ] 
    },
