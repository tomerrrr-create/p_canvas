...
// --- START: Chi Flow Modal Logic ---
    ...
    const CHI_PRESETS = {
        'Topography': { awakening: [3,4,5,6,7,8], flow: [2,3], reach: 2 },
        'Wildfire': { awakening: [1,2,3,4,5,6,7,8], flow: [1,2,3,4], reach: 3 },
        'Crystals': { awakening: [4,5,6,7,8], flow: [1], reach: 1 },
        'Ripples': { awakening: [2,3,4], flow: [2,3,4], reach: 4 }
    };
    ...
    function applyChiPreset(presetName, btnElement) {
        ...
        app.dom.chiReachValue.textContent = tempChiReach;
...
// --- START: Added for Chi Flow Settings ---
    ...
    app.dom.chiReachSlider.addEventListener('input', (e) => {
        app.dom.chiReachValue.textContent = e.target.value;
